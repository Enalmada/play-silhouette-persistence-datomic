...
import models.{UserService, UserServiceImpl}
...
class SilhouetteModule extends AbstractModule with ScalaModule {
  ...
  def provideAuthenticatorService(
                                   ...
                                   encoding: DefaultCookieHeaderEncoding,
    ...
    new CookieAuthenticatorService(config, None, signer, encoding, encoder, fingerprintGenerator, idGenerator, clock)
  }
...
/**
  ...
  */
  ...
  /**
    ...
    */
  @Provides
  def provideSocialStateProvider(
                                  idGenerator: IDGenerator,
                                  @Named("oauth2-state-cookie-signer") signer: Signer,
                                  configuration: Configuration, clock: Clock): DefaultSocialStateHandler = {
  ...
  def provideFacebookProvider(
                               httpLayer: HTTPLayer,
                               stateHandler: DefaultSocialStateHandler,
                               configuration: Configuration): FacebookProvider = {

    new FacebookProvider(httpLayer, stateHandler, configuration.underlying.as[OAuth2Settings]("silhouette.facebook"))
  }
  ...
  def provideVKProvider(
    ...
    new VKProvider(httpLayer, stateHandler, configuration.underlying.as[OAuth2Settings]("silhouette.vk"))
  }
